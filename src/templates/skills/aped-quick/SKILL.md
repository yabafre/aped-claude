...
Read `{{APED_DIR}}/aped-skills/writing-discipline.md` before drafting commit / PR / ticket comment text — short, sharp, slightly human; the diff proves the work, prose adds the *why*.
...
3. **PR/MR**:
   ...
   - Mark the PR/MR ready (`gh pr ready <n>` / `glab mr update --ready`) once the validation block has been re-run locally and is green. See `{{APED_DIR}}/aped-skills/writing-discipline.md` § PRs.
