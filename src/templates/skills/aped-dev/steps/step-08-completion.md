...
- Mark the PR/MR ready (`gh pr ready <n>` / `glab mr update --ready`) once you re-run the validation block locally and it stays green. The body shape (Summary / themed sections / Tests / Validation) is in `{{APED_DIR}}/aped-skills/writing-discipline.md` § PRs.
