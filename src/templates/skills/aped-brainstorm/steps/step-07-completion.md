...
- 🛑 BEFORE declaring complete, Read `{{APED_DIR}}/skills/aped-skills/checklist-brainstorm.md` fresh
...
1. Read `{{APED_DIR}}/skills/aped-skills/checklist-brainstorm.md` fresh.
