...
Always open the PR as `--draft`. Once the Review Record verdict is `done` and the human validation block (see `{{APED_DIR}}/aped-skills/writing-discipline.md` § PRs) re-runs green locally, mark it ready: `gh pr ready <n>`.
